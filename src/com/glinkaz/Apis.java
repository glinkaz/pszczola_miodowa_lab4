...
public class Apis {
    private final List<Pszczola> listaPszczol; //czemu miało byc to final czy to legalne?? przecoez potem dodaję do tego elementy
...
//            };
    ...
    public static final class KrolowaMatka extends Pszczola{
